...
ClapTrap::ClapTrap(int hit_points, int energy_points, int attack_damage) : hit_points_(hit_points), energy_points_(energy_points), attack_damage_(attack_damage) {} // NOLINT
